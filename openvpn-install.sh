...
# https://github.com/kiz77/openvpn-install
...
function installQuestions() {
	...
	echo "The git repository is available at: https://github.com/kiz77/openvpn-install"
	echo ""
	...
	echo "See https://github.com/kiz77/openvpn-install#security-and-encryption to learn more."
	echo ""
...
function installOpenVPN() {
	...
	if [[ ! -e /etc/openvpn/server.conf ]]; then
		if [[ $OS =~ (debian|ubuntu) ]]; then
			...
			yum copr enable dsommers/openvpn-release-2.6 -y
